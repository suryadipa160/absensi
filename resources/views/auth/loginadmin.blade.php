      ...
      <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
                ...
                <div class="card-body">
                  ...
                  <form action="/prosesloginadmin" method="post" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" name="email" class="form-control" value="{{ old('email') }}@if(Session::has('email')) {{ Session::get('email') }} @endif" placeholder="your@email.com" autocomplete="off">
                    </div>
                    <div class="mb-2">
          ...
          <div class="col-lg d-none d-lg-block">
            <img src="{{ asset('assets/img/logoadmin.png') }}" height="500" class="d-block mx-auto" alt="">
          </div>
        </div>
      </div>
    </div>
